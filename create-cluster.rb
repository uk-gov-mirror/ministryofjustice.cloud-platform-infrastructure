...
def create_vpc(vpc_name)
  FileUtils.rm_rf("terraform/aws-accounts/cloud-platform-ephemeral-test/cloud-platform-network/.terraform")
  dir = "terraform/aws-accounts/cloud-platform-ephemeral-test/cloud-platform-network"
...
def create_cluster_kops(cluster_name, vpc_name)
  FileUtils.rm_rf("terraform/aws-accounts/cloud-platform-ephemeral-test/cloud-platform/.terraform")
  dir = "terraform/aws-accounts/cloud-platform-ephemeral-test/cloud-platform"
...
def create_cluster_eks(cluster_name, vpc_name)
  FileUtils.rm_rf("terraform/aws-accounts/cloud-platform-ephemeral-test/cloud-platform-eks/.terraform")
  dir = "terraform/aws-accounts/cloud-platform-ephemeral-test/cloud-platform-eks"
  switch_terraform_workspace(dir, cluster_name)
...
def install_components_kops(cluster_name)
  dir = "terraform/aws-accounts/cloud-platform-ephemeral-test/cloud-platform-components"
